...
pub fn run(cli_args: CliArgs) {
    ...
    let specta_builder = Builder::<tauri::Wry>::new()
        .commands(collect_commands![
            ...
            shortcut::change_assembly_ai_api_key_setting,
            shortcut::change_assembly_ai_language_code_setting,
            ...
            shortcut::change_auto_post_process_on_session_stop_setting,
            ...
            commands::history::post_process_latest_history_entry,
            commands::history::update_history_limit,
            commands::history::update_recording_retention_period,
            commands::history::download_transcript_file,
